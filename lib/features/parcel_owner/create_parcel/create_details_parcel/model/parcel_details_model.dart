class ParcelDetailsModel {
    ...
    factory ParcelDetailsModel.fromJson(Map<String, dynamic> json) => ParcelDetailsModel(
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        v: json["__v"],
        priceRequests: json["price_requests"] == null ? [] : List<dynamic>.from(json["price_requests"]!.map((x) => x)),
        review: json["review"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "__v": v,
        "price_requests": priceRequests == null ? [] : List<dynamic>.from(priceRequests!.map((x) => x)),
        "review": review,
        "id": dataId,
    };
}
...
class UserId {
    ...
    factory UserId.fromJson(Map<String, dynamic> json) => UserId(
        ...
        passwordChangedAt: json["password_changed_at"] == null ? null : DateTime.parse(json["password_changed_at"]),
        v: json["__v"],
        address: json["address"],
